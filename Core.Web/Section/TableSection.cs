...
{
	public class TableSection : IRender
	{
		public TableSection(string id, string sectionName)
		{
			this.Id = id;
		...
		public string Render()
		{
			...
			this.Node = new Node(TagName.p, dictionary, $"{{{this.Id}}}");
			...
			h4Node.AddChildNode(new Node(TagName.a, dictionary2, SectionName));
