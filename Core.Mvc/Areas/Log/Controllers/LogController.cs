...
namespace Core.Mvc.Areas.Log.Controllers
{
    ...
    public class LogController : StandardController
    {
        ...
        public IActionResult Index()
        {
            ...
            var model = AsyncRequest.GetAsync<IList<Entity.DataModels.Log>>(url).Result;
        ...
        public IActionResult GridStateChange(LogPostModel model)
        {
            ...
            ResponseModel response = AsyncRequest.PostAsync<IList<Entity.DataModels.Log>, LogPostModel>(url, model).Result;
